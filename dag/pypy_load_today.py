...
ENDPOINT_URL = "https://test-oscareo-service-749045337548.europe-west1.run.app/load-pypi-current-day"
...
with DAG(
    ...
    description='Appelle endpoint Cloud Run et vérifie l’exportation',
